...
1. You [open a discussion](https://github.com/codetocloudinc/platform-engineering-hub/discussions) to discuss any significant work with the maintainer(s).
...
Example:
```shell
git remote add upstream https://github.com/codetocloudinc/platform-engineering-hub.git
...
When your branch gets out of sync with the  platform-engineering-hub/main branch, use the following to update:
...
Looking at the existing issues is a great way to find something to contribute on. If you have an idea you'd like to discuss, [open a discussion](https://github.com/codetocloudinc/platform-engineering-hub/discussions).
